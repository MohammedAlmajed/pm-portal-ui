...
const HEADLINE: Record<BrokerStage, { title: string; desc: string }> = {
  ...
  pending: {
    ...
    desc: 'بانتظار قرار المطوّر. ستتفعّل صفحة العملاء المحتملين وروابط الإحالة بعد الاعتماد.',
  },
  'rejected-only': {
  ...
  approved: {
    title: 'تم اعتمادك 🎉',
    desc: 'أصبحت وسيطًا معتمدًا. شارك روابط الإحالة وتابع عملاءك المحتملين.',
  },
};
